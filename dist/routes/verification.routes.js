...
import { authenticate, authorize, uploadIdCard, handleUploadError, } from '../middleware/index.js';
const router = Router();
/**
 * @swagger
 * tags:
...
// Submit verification
router.post('/submit', uploadIdCard.single('idCard'), handleUploadError, verificationController.submitVerification);
