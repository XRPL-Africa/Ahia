...
import { authenticate, optionalAuth, requireVerified, uploadListingImages, handleUploadError, apiRateLimiter, } from '../middleware/index.js';
const router = Router();
/**
 * @swagger
 * tags:
 ...
 *       - bearerAuth: []
 */
router.post('/', requireVerified, uploadListingImages.array('images', 5), handleUploadError, listingController.createListing);
/**
 * @swagger
 * /listings/{id}:
 *   patch:
