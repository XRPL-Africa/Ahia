...
import { authenticate, requireVerified, uploadDisputeEvidence, handleUploadError, webhookRateLimiter, } from '../middleware/index.js';
const router = Router();
/**
 * @swagger
 * tags:
 ...
 *     tags: [Escrow]
 */
router.post('/disputes', requireVerified, uploadDisputeEvidence.array('evidence', 5), handleUploadError, escrowController.openDispute);
