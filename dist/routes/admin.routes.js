...
import { authenticate, authorize, uploadCampusLogo, handleUploadError, } from '../middleware/index.js';
const router = Router();
/**
 * @swagger
 * tags:
...
router.post('/campuses', uploadCampusLogo.single('logo'), handleUploadError, adminController.createCampus);
