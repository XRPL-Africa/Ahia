...
// Suppress push notifications while this chat is open
...
export const ChatScreen: React.FC<ChatScreenProps> = ({
  ...
  // Tell NotificationService we're viewing this chat so push notifications
  // for new messages here are suppressed while the screen is open
  useEffect(() => {
    NotificationService.setActiveChatId(chatId);
    return () => NotificationService.setActiveChatId(null);
  }, [chatId]);
